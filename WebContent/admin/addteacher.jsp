...
<body>
  <form action="/ChooseCourse/AddTeacherServlet.do" method="post"
     ...
     <table>
       ...
       <tr>
        <td>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码：</td>
        <td><input type="password" class="input" name="tcr_pass" id="tcr_pass" 
              onfocus="focusText('tcr_pass','pass_msg')"
              onblur="checkText('tcr_pass','pass_msg')"></td>
       ...
       <tr>
        ...
        <td><input type="text" class="input" name="tcr_tel" id="tcr_tel"
                   ...
                   onblur="checkText('tcr_tel','tel_msg')"></td>
       ...
       <tr>
        <td>生&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日：</td>
        <td>
            <input type="date" name="tcr_birth" id="tcr_birth">
        </td>
        <td></td>
       </tr>
...
<script type="text/javascript">
     ...
     var arr_textid = ["tcr_name","tcr_pass","tcr_tel"];
     var arr_msgid = ["name_msg","pass_msg","tel_msg"];
